package com.kzw.wordtohtml.word;
...
public class WordUtil {
    ...
    public WordUtil(String filePath, String htmlPath) {
        docPath = filePath;
                ...
                switch (event_type) {
                    case XmlPullParser.START_TAG: // 开始标签
                        ...
                        if (tagBegin.equalsIgnoreCase("sz")) { // 判断文字大小
                            if (isRegion) {
                                int size = getSize(Integer.parseInt(xmlParser.getAttributeValue(0)));
    ...
    public void writeDocumentPicture(byte[] pictureBytes) {
        ...
        String picturePath = FileUtil.createFile(file.getParent(), FileUtil.getFileName(docPath) + presentPicture + ".jpg");
